...
plt.axis([-16,16,0,16])   #set x and y axis limits
...
time.sleep(.75)  #pause updates by 0.5s

#define the ball's initial velocity and acceleration
ball_vel = np.array([0.0,15.0])
g = 9.8
